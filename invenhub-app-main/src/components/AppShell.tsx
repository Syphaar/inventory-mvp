...
export function AppShell() {
  ...
  return (
    <div className="h-screen bg-background flex overflow-hidden">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 bg-sidebar text-sidebar-foreground flex flex-col border-r border-sidebar-border transition-transform lg:translate-x-0",
